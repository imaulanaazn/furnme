      ...
      <footer className="grid lg:grid-cols-4 md:text-center grid-cols-2 gap-x-6 gap-y-6 lg:gap-y-0 py-14 lg:px-12 px-8">
        ...
        <div className="menu lg:mx-auto md:text-center md:mx-0 mr-auto">
          ...
          <ul>
            ...
            <li className="my-1"><a href="signform" className="lg:text-sm md:text-base ">Signup</a></li>
          </ul>
        </div>
        <div className="info lg:mx-auto md:text-center md:mx-0 ml-auto">
          ...
          <ul>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">About Us</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Terms & Conditions</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">User&apos;s Guide</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Support Center</a></li>
          </ul>
        </div>
        <div className="social_media lg:mx-auto md:text-center md:mx-0 mr-auto " id="contact">
          ...
          <ul>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Twitter</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Facebook</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Telegram</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Discord</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Telephone</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Whatsapp</a></li>
            <li className="my-1"><a href="/#" className="lg:text-sm md:text-base ">Email</a></li>
          </ul>
        </div>
      </footer>
      <div
