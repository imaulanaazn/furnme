  ...
  return (
    <section className="hero relative w-full h-screen">
      ...
      <div className="text text-center w-5/6  absolute lg:top-2/4 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 zindex-1">
        <h1 className="title text-slate-800 font-extrabold xl:text-4xl lg:text-2xl md:text-3xl text-lg text-center md:max-w-[24rem] md:mx-auto">ALTAR</h1>
        <p className="xl:text-lg lg:text-base md:text-xl text-sm text-slate-800 font-semibold mt-2 mt-10">Discover the most beautiful furniture</p>
        <p className="lg:text-base md:text-xl text-sm text-slate-500 mt-2 mb-10 max-w-lg mx-auto">
