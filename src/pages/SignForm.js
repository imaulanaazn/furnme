  ...
  return (
    <div className="bg-orange-100 w-screen h-screen flex items-center">
      <div className="container lg:block flex flex-col bg-white lg:w-4/6 md:w-4/5 w-11/12 h-4/5 m-auto  rounded-lg overflow-hidden relative">
        <div className="logo absolute top-4 left-4 z-10 flex items-end">
          <img src="../src/images/logo.png" className="w-6" alt="" />
        ...
        <main ref={main} className="bg-white h-full lg:w-3/5 w-full p-10 ml-auto flex flex-col flex-1 items-center justify-center">
          ...
          <input type="text" ref={username} placeholder="Enter your username" className="username bg-slate-200 hidden rounded text-xs h-8 w-72 px-3 mb-1 text-slate-600" />
          <input type="email" placeholder="Enter your email" className="bg-slate-200 rounded lg:text-xs text-xs md:text-xl lg:h-8 h-8 lg:w-72 w-72 md:w-4/5 md:h-12 px-3 mb-1 text-slate-600" />
          <input type="password" placeholder="Enter you passord" className="bg-slate-200 rounded lg:text-xs text-xs md:text-xl lg:h-8 h-8 lg:w-72 w-72 md:w-4/5 md:h-12 px-3" />
          ...
          <div className="socmed flex justify-between lg:w-24 w-24 md:w-36 mt-6 ">
            ...
            <img src="../src/icons/google.svg" className="lg:w-5 w-5 md:w-7" alt="google" />

            <img src="../src/icons/facebook.svg" className="lg:w-5 w-5 md:w-7" alt="facebook" />

            <img src="../src/icons/linkedin.svg" className="lg:w-5 w-5 md:w-7" alt="linkedin" />
        ...
        <div ref={welcome} className="welcome h-1/2 opacity-0 translate-x-10 absolute top-0 right-0 z-10 w-2/5 flex flex-col items-center justify-end px-12 text-center">
        ...
        <div ref={welcomeBack} className="welcome-back h-1/2 hidden absolute top-0 z-10 w-2/5 lg:flex flex-col items-center justify-end px-12 text-center">
